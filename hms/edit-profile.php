...
<html lang="fr">
    <head>
        <title>Utilisateur | Modifier le profil</title>
                ...
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Utilisateur | Modifier le profil</h1>
                                                                                                    </div>
                                <ol class="breadcrumb">
                                    <li>
                                        ...
                                        <div class="col-lg-8 col-md-12">
                                            <div class="panel panel-white">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title">Modifier le profil</h5>
                                                </div>
...
<p><b>Date d'inscription du profil : </b><?php echo htmlentities($data['regDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Dernière date de mise à jour : </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
...
<div class="form-group">
                    ...
                    <a href="change-emaild.php">Mettre à jour votre adresse email</a>
                                                                                        </div>
