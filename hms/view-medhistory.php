...
<html lang="fr">
    <head>
        <title>Utilisateurs | Historique Médical</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Utilisateurs | Historique Médical</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Historique <span class="text-bold">Médical</span></h5>
<?php
                               $vid=$_GET['viewid'];
...
<td colspan="4" style="font-size:20px;color:blue">
 Détails du Patient</td></tr>
  ...
  <tr>
    ...
    <th>Antécédents Médicaux (si existants)</th>
