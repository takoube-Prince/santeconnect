    ...
    <body class="login">
        <div class="row">
            <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                ...
                <a href="../index.php"><h2> SC | Connexion Patient</h2></a>
                </div>
                ...
                <div class="box-login">
                    <form class="form-login" method="post">
                        <fieldset>
                            ...
                            <p>
                                Veuillez saisir votre identifiant et votre mot de passe pour vous connecter.<br />
                                <span style="color:red;"><?php echo $_SESSION['errmsg']; ?><?php echo $_SESSION['errmsg']="";?></span>
                            </p>
                            <div class="form-group">
                                <span class="input-icon">
                                    <input type="email" class="form-control" name="username" placeholder="Adresse email" required>
                    ...
                    <div class="copyright">
                        </span><span class="text-bold text-uppercase"> Santé Connect</span>.
                    </div>
