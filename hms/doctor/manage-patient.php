...
<td>
<a href="edit-patient.php?editid=<?php echo $row['ID'];?>" class="btn btn-primary btn-sm" target="_blank"><i class="fa fa-edit"></i> Modifier</a> 
<a href="view-patient.php?viewid=<?php echo $row['ID'];?>" class="btn btn-warning btn-sm" target="_blank"><i class="fa fa-eye"></i> Voir Détails</a>
</td>
</tr>
<?php 
$cnt=$cnt+1;
