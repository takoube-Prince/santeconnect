...
<html lang="fr">
    ...
    <head>
        <title>Inscription Utilisateur - SC</title>
    ...
    <body class="login">
        <div class="row">
            <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                ...
                <a href="../index.php"><h2>SC | Inscription Patient</h2></a>
                </div>
                <div class="box-register">
                    <form name="registration" id="registration"  method="post" onSubmit="return valid();">
                        <fieldset>
                            ...
                            <p>
                                Saisissez vos données personnelles ci-dessous :
                            </p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="clip-radio radio-primary">
                                    <input type="radio" id="rg-female" name="gender" value="féminin" >
                                    <label for="rg-female">
                                        Féminin
                                    </label>
                            ...
                            <p>
                                Saisissez les identifiants de votre compte ci-dessous :
                            </p>
                            <div class="form-group">
                                <span class="input-icon">
                                    <input type="email" class="form-control" name="email" id="email" onBlur="userAvailability()"  placeholder="Adresse email" required>
                    ...
                    <div class="copyright">
                        &copy; <span class="current-year"></span><span class="text-bold text-uppercase"> SC</span>. <span>Tous droits réservés</span>
                    </div>
