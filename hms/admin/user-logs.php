...
<html lang="fr">
    <head>
        <title>Admin | Journaux de connexion des utilisateurs</title>
                ...
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Admin | Journaux de connexion des utilisateurs</h1>
                                                                                    </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Admin</span>
                                ...
                                <?php echo htmlentities($_SESSION['msg']="");?></p> 
                                    <table class="table table-hover" id="sample-table-1">
                                        <thead>
                                            <tr>
                                                <th class="center">#</th>
                                                <th class="hidden-xs">ID Utilisateur</th>
