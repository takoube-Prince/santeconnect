...
<html lang="fr">
    <head>
        <title>Admin | Détails de la demande</title>
                ...
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Admin | Détails de la demande</h1>
                                                                                    </div>
                        ...
                        <div class="container-fluid container-fullw bg-white">
                                    ...
                                    <div class="row">
                                <div class="col-md-12">
                                    <h5 class="over-title margin-bottom-15">Gérer les <span class="text-bold">détails de la demande</span></h5>
                                                <hr />
...
<form name="query" method="post">
    <tr>
                                        ...
                                        Mettre à jour <i class="fa fa-arrow-circle-right"></i>
                                </button>
