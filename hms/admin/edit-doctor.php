...
$did=intval($_GET['id']);// Récupération de l'ID du médecin
...
if($sql)
{
$msg="Les informations du médecin ont été mises à jour avec succès.";
...
<html lang="fr">
    <head>
        <title>Admin | Modifier les informations du médecin</title>
            ...
            <div class="app-content">
                    ...
                    <div class="wrap-content container" id="container">
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Admin | Modifier les informations du médecin</h1>
                                                                                    </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Admin</span>
