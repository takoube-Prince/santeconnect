...
$pagedes=$con->real_escape_string($_POST['pagedes']);
    ...
    echo '<script>alert("La page À propos a été mise à jour avec succès.")</script>';
  }
  else
    {
...
<html lang="fr">
    <head>
        <title>Admin | À propos de nous</title>
                ...
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Admin | Modifier le contenu de la page À propos</h1>
                                                                                    </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Admin</span>
                                    ...
                                    <li class="active">
                                        <span>Modifier le contenu À propos</span>
                                    </li>
                                </ol>
                            </div>
                        </section>
...
?>
                                    ...
                                    <?php } ?>
                                    <button type="submit" class="btn btn-primary mr-2" name="submit">Enregistrer les modifications</button>
                                  </form>
                                </div>
                            </div>
                                </div>
